      ...
      <div class="grid">
        ...
        <div class="graph-card">
          ...
          <div class="range-chips">
            ${Object.entries(qt).map(([u,y])=>z`
              <div class="range-chip ${T({active:this._range===u})}"
                   @click=${()=>this._rangeHistory(u)} role="button">${y}</div>
            `)}
          </div>
        </div>
